...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.putId = function(idAsesoria, idDocente) {
        asesoriaIdInput.value = idAsesoria;
        docenteIdInput.value = idDocente;
    };
    ...
    ratingForm.addEventListener('submit', (event) => {
        ...
        fetch('http://localhost:8081/SGAA_war_exploded/CalificarDocente', {
            method: 'POST',
            headers: {
    ...
    modalElement.addEventListener('hidden.bs.modal', () => {
        ...
        docenteIdInput.value = ''; // Limpia el valor del input de id de estudiante
